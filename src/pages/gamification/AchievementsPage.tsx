...
function AchievementCard({
  ...
  return (
    <div
      className={`ach-card ${unlocked ? 'unlocked' : ''} ${isShowcased ? 'showcased' : ''} relative overflow-hidden rounded-2xl border bg-white/[0.04] p-6 backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5 hover:border-indigo-300/35 hover:bg-white/[0.07] ${cardBorder} animate-fade-rise`}
